...
- Во втором случае `SIMD` инструкция раскрывается в одну ассемблерную инструкцию.
 ...
 В четвертом столбце указано отношение количества тактов к характерной величине.

|Программа  | Оптимизация |Кол-во тактов * 10<sup>9</sup>  | 1 / Характерная величина|
|:---------:|:-------------:|:---------:|:-----------:|
|  Simple   | -O3  | 21.08   |  1.0      |
|   Vector   |-03  |46.06   |  2.19    |
| Vector |  -03 -fno-unroll-loops |  39.72 | 1.88 |
|    SIMD  | -O3 |2.79   |  0,13     |
